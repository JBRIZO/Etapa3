...
var _funcionGraficoJs = require("./funcionGrafico.js");
var _categoriaServiceMjs = require("./services/CategoriaService.mjs");
var _marcaServiceMjs = require("./services/MarcaService.mjs");
var _productoServiceMjs = require("./services/ProductoService.mjs");
var _ventaServiceMjs = require("./services/VentaService.mjs");
const categoriaSelect = document.getElementById("categoria");
const productoSelect = document.getElementById("producto");
const marcaSelect = document.getElementById("marca");
const form = document.getElementById("form");
const categoriaService = new (0, _categoriaServiceMjs.CategoriaService)();
const productoService = new (0, _productoServiceMjs.ProductoService)();
const marcasService = new (0, _marcaServiceMjs.MarcaService)();
const ventasService = new (0, _ventaServiceMjs.VentaService)();
...
form.addEventListener("change", (event)=>{
    if (event.target.id === categoriaSelect.id) {
        ...
        productoService.getProductosByCategoria(categoriaSelect.value).then((response)=>{
            response.forEach((element)=>{
    ...
    if (+productoSelect.value !== 0 && +marcaSelect.value !== 0) {
        ...
        ventasService.getVentasByMarca(marcaSelect.value).then((response)=>{
            ...
            (0, _funcionGraficoJs.crearGraficoBarras)(chartItems);
        });
    }
});
...
},{"./services/CategoriaService.mjs":"6eg2m","./services/MarcaService.mjs":"gSqTG","./services/ProductoService.mjs":"Jv4Cx","./services/VentaService.mjs":"jkZjB","./funcionGrafico.js":"cGinO"}],"6eg2m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CategoriaService", ()=>CategoriaService);
var _http = require("./Http");
class CategoriaService {
    #endpoint = `http://localhost:3000/categorias`;
    #http = new (0, _http.HttpService)();
    async getCategorias() {
        try {
...
},{"./Http":"jYhAl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jYhAl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "HttpService", ()=>HttpService);
class HttpService {
    get(url) {
...
},{}],"gSqTG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MarcaService", ()=>MarcaService);
var _http = require("./Http");
class MarcaService {
    ...
    async getMarcasByProducto(productoId) {
        try {
            const response = await this.#http.get(`${this.#endpoint}/marcas?idProducto=${productoId}`);
            return response;
        } catch (error) {
            throw new Error(`Request failed: ${error.message}`);
        }
...
},{"./Http":"jYhAl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Jv4Cx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ProductoService", ()=>ProductoService);
var _http = require("./Http");
class ProductoService {
    ...
    async getProductosByCategoria(categoriaId) {
        try {
            const response = await this.#http.get(`${this.#endpoint}?idCategoria=${+categoriaId}`);
            return response;
        } catch (error) {
            throw new Error(`Request failed: ${error.message}`);
        }
...
},{"./Http":"jYhAl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jkZjB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "VentaService", ()=>VentaService);
var _http = require("./Http");
class VentaService {
    ...
    async getVentasByMarca(marcaId) {
        try {
            const response = await this.#http.get(`${this.#endpoint}?idMarca=${marcaId}`);
            return response;
        } catch (error) {
            throw new Error(`Request failed: ${error.message}`);
        }
...
},{"./Http":"jYhAl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cGinO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "crearGraficoBarras", ()=>crearGraficoBarras);
var _auto = require("chart.js/auto");
const crearGraficoBarras = (data)=>{
    const existingChart = (0, _auto.Chart).getChart("ventasMensuales");
    if (existingChart) existingChart.destroy();
    new (0, _auto.Chart)(document.getElementById("ventasMensuales"), {
        type: "bar",
        data: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["j9r0q","ebWYT"], "ebWYT", "parcelRequire625b")
