...
})(
  {
    gWjva: [
      function (require, module, exports) {
        ...
        module.bundle.HMR_BUNDLE_ID = '1da2f0d351339dd5';
        ('use strict');
...
${frame.code}`;
    ...
    '4kpjW': [
      function (require, module, exports) {
        ...
        const createBarChart = data => {
          new (0, _auto.Chart)(document.getElementById('monthlySales'), {
            type: 'bar',
            data: {
    ...
    ipU8D: [
      function (require, module, exports) {
        ...
        class Animation {
          constructor(cfg, target, prop, to) {
            ...
            to = (0, _helpersSegmentJs.a)([cfg.to, to, currentValue, cfg.from]);
            const from = (0, _helpersSegmentJs.a)([cfg.from, currentValue, to]);
            this._active = true;
            this._fn = cfg.fn || interpolators[cfg.type || typeof from];
            this._easing =
              (0, _helpersSegmentJs.e)[cfg.easing] ||
              (0, _helpersSegmentJs.e).linear;
        ...
        class Animations {
          ...
          configure(config) {
            ...
            const animationOptions = Object.keys(
              (0, _helpersSegmentJs.d).animation
            );
            ...
            Object.getOwnPropertyNames(config).forEach(key => {
              ...
              (
                ((0, _helpersSegmentJs.b)(cfg.properties) &&
                  cfg.properties) || [key]
              ).forEach(prop => {
        ...
        function applyStack(stack, value, dsIndex, options = {}) {
          ...
          for (i = 0, ilen = keys.length; i < ilen; ++i) {
            ...
            if (
              (0, _helpersSegmentJs.g)(otherValue) &&
              (singleMode ||
                value === 0 ||
                (0, _helpersSegmentJs.s)(value) ===
                  (0, _helpersSegmentJs.s)(otherValue))
            )
              value += otherValue;
          }
          return value;
        ...
        class DatasetController {
          ...
          linkScales() {
            ...
            const chooseId = (axis, x, y, r) =>
              axis === 'x' ? x : axis === 'r' ? r : y;
            const xid = (meta.xAxisID = (0, _helpersSegmentJs.v)(
              dataset.xAxisID,
              getFirstScaleId(chart, 'x')
            ));
            const yid = (meta.yAxisID = (0, _helpersSegmentJs.v)(
              dataset.yAxisID,
              getFirstScaleId(chart, 'y')
            ));
            const rid = (meta.rAxisID = (0, _helpersSegmentJs.v)(
              dataset.rAxisID,
          ...
          _dataCheck() {
            ...
            if ((0, _helpersSegmentJs.i)(data))
              ...
              if (data && Object.isExtensible(data))
                (0, _helpersSegmentJs.l)(data, this);
              this._syncList = [];
              this._data = data;
            }
          }
          ...
          parse(start, count) {
            ...
            if (this._parsing === false) {
              ...
              if ((0, _helpersSegmentJs.b)(data[start]))
                parsed = this.parseArrayData(meta, data, start, count);
              else if ((0, _helpersSegmentJs.i)(data[start]))
          ...
          parseObjectData(meta, data, start, count) {
            ...
            for (i = 0, ilen = count; i < ilen; ++i) {
              ...
              parsed[i] = {
                x: xScale.parse(
                  (0, _helpersSegmentJs.f)(item, xAxisKey),
                  index
                ),
                y: yScale.parse(
                  (0, _helpersSegmentJs.f)(item, yAxisKey),
                  index
                ),
              };
            }
          ...
          getMinMax(scale, canStack) {
            ...
            function _skip() {
              ...
              return (
                !(0, _helpersSegmentJs.g)(parsed[scale.axis]) ||
                otherMin > otherValue ||
                otherMax < otherValue
              );
            }
          ...
          _resolveElementOptions(elementType, mode = 'default', index) {
            ...
            const sharing =
              this.enableOptionSharing && (0, _helpersSegmentJs.h)(index);
            ...
            const names = Object.keys(
              (0, _helpersSegmentJs.d).elements[elementType]
            );
        ...
        function getAllScaleValues(scale, type) {
          if (!scale._cache.$bar) {
            ...
            scale._cache.$bar = (0, _helpersSegmentJs._)(
              values.sort((a, b) => a - b)
            );
          }
        ...
        function parseValue(entry, item, vScale, i) {
          if ((0, _helpersSegmentJs.b)(entry))
        ...
        class BarController extends DatasetController {
          ...
          parseObjectData(meta, data, start, count) {
            ...
            for (i = start, ilen = start + count; i < ilen; ++i) {
              ...
              item[iScale.axis] = iScale.parse(
                (0, _helpersSegmentJs.f)(obj, iAxisKey),
                i
              );
              parsed.push(
                parseValue(
                  (0, _helpersSegmentJs.f)(obj, vAxisKey),
                  item,
                  vScale,
                  i
                )
          ...
          updateElements(bars, start, count, mode) {
            ...
            for (let i = start; i < start + count; i++) {
              ...
              const vpixels =
                reset || (0, _helpersSegmentJs.k)(parsed[vScale.axis])
                  ? {
                      base,
                      head: base,
                    }
          ...
          _calculateBarValuePixels(index) {
            ...
            if (floating) {
              ...
              if (
                value !== 0 &&
                (0, _helpersSegmentJs.s)(value) !==
                  (0, _helpersSegmentJs.s)(custom.barEnd)
              )
                start = 0;
              start += value;
            }
            const startValue =
              !(0, _helpersSegmentJs.k)(baseValue) && !floating
                ? baseValue
                : start;
          ...
          _calculateBarIndexPixels(index, ruler) {
            ...
            const maxBarThickness = (0, _helpersSegmentJs.v)(
        ...
        class BubbleController extends DatasetController {
          ...
          parseArrayData(meta, data, start, count) {
            ...
            for (let i = 0; i < parsed.length; i++) {
              ...
              parsed[i]._custom = (0, _helpersSegmentJs.v)(
                item[2],
          ...
          resolveDataElementOptions(index, mode) {
            ...
            values.radius += (0, _helpersSegmentJs.v)(
        ...
        function getRatioAndOffset(rotation, circumference, cutout) {
          ...
          if (circumference < (0, _helpersSegmentJs.T)) {
            ...
            const calcMax = (angle, a, b) =>
              (0, _helpersSegmentJs.p)(angle, startAngle, endAngle, true)
                ? 1
            ...
            const minY = calcMin(
              (0, _helpersSegmentJs.P) + (0, _helpersSegmentJs.H),
              startY,
              endY
            );
            ratioX = (maxX - minX) / 2;
        ...
        class DoughnutController extends DatasetController {
          ...
          update(mode) {
            ...
            const cutout = Math.min(
              (0, _helpersSegmentJs.m)(this.options.cutout, maxSize),
              1
            );
            ...
            const outerRadius = (0, _helpersSegmentJs.n)(
              this.options.radius,
              maxRadius
            );
          ...
          _circumference(i, reset) {
            ...
            return this.calculateCircumference(
              (meta._parsed[i] * circumference) / (0, _helpersSegmentJs.T)
            );
          }
          ...
          calculateCircumference(value) {
            ...
            if (total > 0 && !isNaN(value))
              return (0, _helpersSegmentJs.T) * (Math.abs(value) / total);
            return 0;
          }
          getLabelAndValue(index) {
            const meta = this._cachedMeta;
            ...
            const value = (0, _helpersSegmentJs.o)(
              meta._parsed[index],
        ...
        class LineController extends DatasetController {
          ...
          update(mode) {
            ...
            let { start, count } = (0, _helpersSegmentJs.q)(
              meta,
              points,
              animationsDisabled
            );
          ...
          updateElements(points, start, count, mode) {
            ...
            const maxGapLength = (0, _helpersSegmentJs.x)(spanGaps)
              ? spanGaps
        ...
        class PolarAreaController extends DatasetController {
          ...
          parseObjectData(meta, data, start, count) {
            return (0, _helpersSegmentJs.y).bind(this)(
              meta,
              data,
              start,
              count
          ...
          updateElements(arcs, start, count, mode) {
            ...
            const datasetStartAngle =
              scale.getIndexAngle(0) - 0.5 * (0, _helpersSegmentJs.P);
        ...
        function binarySearch(metaset, axis, value, intersect) {
          ...
          if (
            ...
            const lookupMethod = iScale._reversePixels
              ? (0, _helpersSegmentJs.A)
              : (0, _helpersSegmentJs.B);
        ...
        function getIntersectItems(
          ...
          const evaluationFunc = function (element, datasetIndex, index) {
            if (
              !includeInvisible &&
              !(0, _helpersSegmentJs.C)(element, chart.chartArea, 0)
            )
              return;
        ...
        function getNearestRadialItems(
          ...
          function evaluationFunc(element, datasetIndex, index) {
            ...
            if ((0, _helpersSegmentJs.p)(angle, startAngle, endAngle))
              items.push({
                element,
                datasetIndex,
                index,
        ...
        var layouts = {
          ...
          update(chart, width, height, minPadding) {
            if (!chart) return;
            const padding = (0, _helpersSegmentJs.E)(
        ...
        class Element {
          ...
          hasValue() {
            return (
              (0, _helpersSegmentJs.x)(this.x) &&
              (0, _helpersSegmentJs.x)(this.y)
            );
          }
        ...
        function autoSkip(scale, ticks) {
          ...
          if (numMajorIndices > 0) {
            ...
            skip(
              ...
              newTicks,
              spacing,
              (0, _helpersSegmentJs.k)(avgMajorSpacing)
                ? 0
        ...
        function getMajorIndices(ticks) {
          ...
          for (i = 0, ilen = ticks.length; i < ilen; i++)
            if (ticks[i].major) result.push(i);
          return result;
        }
        ...
        function skip(ticks, newTicks, spacing, majorStart, majorEnd) {
          ...
          const end = Math.min(
            (0, _helpersSegmentJs.v)(majorEnd, ticks.length),
            ticks.length
          );
          let count = 0;
          let length, i, next;
        ...
        function getTitleHeight(options, fallback) {
          ...
          const lines = (0, _helpersSegmentJs.b)(options.text)
            ? options.text.length
            : 1;
        ...
        class Scale extends Element {
          ...
          getUserBounds() {
            ...
            _userMin = (0, _helpersSegmentJs.O)(
              _userMin,
              Number.POSITIVE_INFINITY
            );
            _userMax = (0, _helpersSegmentJs.O)(
              _userMax,
              Number.NEGATIVE_INFINITY
            );
            _suggestedMin = (0, _helpersSegmentJs.O)(
              _suggestedMin,
              Number.POSITIVE_INFINITY
            );
            _suggestedMax = (0, _helpersSegmentJs.O)(
              _suggestedMax,
              Number.NEGATIVE_INFINITY
            );
            return {
          ...
          getMinMax(canStack) {
            ...
            return {
              min: (0, _helpersSegmentJs.O)(
                min,
                (0, _helpersSegmentJs.O)(max, min)
              ),
              max: (0, _helpersSegmentJs.O)(
                max,
                (0, _helpersSegmentJs.O)(min, max)
              ),
            };
          }
          getPadding() {
          ...
          beforeUpdate() {
            (0, _helpersSegmentJs.Q)(this.options.beforeUpdate, [this]);
          }
          ...
          afterUpdate() {
            (0, _helpersSegmentJs.Q)(this.options.afterUpdate, [this]);
          }
          beforeSetDimensions() {
            (0, _helpersSegmentJs.Q)(this.options.beforeSetDimensions, [this]);
          }
          setDimensions() {
            if (this.isHorizontal()) {
          ...
          afterSetDimensions() {
            (0, _helpersSegmentJs.Q)(this.options.afterSetDimensions, [this]);
          }
          _callHooks(name) {
            this.chart.notifyPlugins(name, this.getContext());
            (0, _helpersSegmentJs.Q)(this.options[name], [this]);
          }
          beforeDataLimits() {
          ...
          generateTickLabels(ticks) {
            ...
            for (i = 0, ilen = ticks.length; i < ilen; i++) {
              tick = ticks[i];
              tick.label = (0, _helpersSegmentJs.Q)(
                tickOpts.callback,
                [tick.value, i, ticks],
                this
              );
          ...
          calculateLabelRotation() {
            ...
            const maxWidth = (0, _helpersSegmentJs.S)(
            ...
            if (maxLabelWidth + 6 > tickWidth) {
              ...
              labelRotation = (0, _helpersSegmentJs.U)(
                Math.min(
                  Math.asin(
                    (0, _helpersSegmentJs.S)(
          ...
          afterAutoSkip() {}
          beforeFit() {
            (0, _helpersSegmentJs.Q)(this.options.beforeFit, [this]);
          }
          fit() {
            const minSize = {
              width: 0,
            ...
            if (display) {
              ...
              if (tickOpts.display && this.ticks.length) {
                ...
                const angleRadians = (0, _helpersSegmentJs.t)(
                  this.labelRotation
                );
          ...
          afterFit() {
            (0, _helpersSegmentJs.Q)(this.options.afterFit, [this]);
          }
          isHorizontal() {
          ...
          _convertTicksToLabels(ticks) {
            ...
            let i, ilen;
            for (i = 0, ilen = ticks.length; i < ilen; i++)
              if ((0, _helpersSegmentJs.k)(ticks[i].label)) {
                ticks.splice(i, 1);
                ilen--;
                i--;
              }
          ...
          _computeLabelSizes(ticks, length, maxTicksLimit) {
            ...
            for (i = 0; i < length; i += increment) {
              ...
              width = height = 0;
              if (
                !(0, _helpersSegmentJs.k)(label) &&
                !(0, _helpersSegmentJs.b)(label)
              ) {
                width = (0, _helpersSegmentJs.V)(
                  ctx,
                  cache.data,
                  cache.gc,
                  width,
                ...
                height = lineHeight;
              } else if ((0, _helpersSegmentJs.b)(label))
                for (j = 0, jlen = label.length; j < jlen; ++j) {
                  nestedLabel = label[j];
                  if (
                    !(0, _helpersSegmentJs.k)(nestedLabel) &&
                    !(0, _helpersSegmentJs.b)(nestedLabel)
                  ) {
                    width = (0, _helpersSegmentJs.V)(
                      ctx,
                      cache.data,
          ...
          getPixelForDecimal(decimal) {
            ...
            return (0, _helpersSegmentJs.W)(
              this._alignToPixels
                ? (0, _helpersSegmentJs.X)(this.chart, pixel, 0)
                : pixel
            );
          }
          ...
          _computeGridLineItems(chartArea) {
            ...
            const limit = (0, _helpersSegmentJs.v)(
              options.ticks.maxTicksLimit,
              ticksLength
            );
            ...
            for (i = 0; i < ticksLength; i += step) {
              ...
              alignedLineValue = (0, _helpersSegmentJs.X)(
                chart,
                lineValue,
                lineWidth
              );
          ...
          _computeLabelItems(chartArea) {
            ...
            for (i = 0, ilen = ticks.length; i < ilen; ++i) {
              ...
              if (optsAtIndex.showLabelBackdrop) {
                const labelPadding = (0, _helpersSegmentJs.E)(
          ...
          drawBorder() {
            ...
            if (this.isHorizontal()) {
              x1 =
                (0, _helpersSegmentJs.X)(chart, this.left, axisWidth) -
                axisWidth / 2;
              x2 =
                (0, _helpersSegmentJs.X)(chart, this.right, lastLineWidth) +
                lastLineWidth / 2;
              y1 = y2 = borderValue;
            } else {
              y1 =
                (0, _helpersSegmentJs.X)(chart, this.top, axisWidth) -
                axisWidth / 2;
              y2 =
                (0, _helpersSegmentJs.X)(chart, this.bottom, lastLineWidth) +
                lastLineWidth / 2;
              x1 = x2 = borderValue;
            }
            ctx.save();
          ...
          drawTitle() {
            ...
            if (
              position === 'bottom' ||
              position === 'center' ||
              (0, _helpersSegmentJs.i)(position)
            ) {
              offset += padding.bottom;
              if ((0, _helpersSegmentJs.b)(title.text))
          ...
          _layers() {
            ...
            const bz = (0, _helpersSegmentJs.v)(
        ...
        class TypedRegistry {
          ...
          register(item) {
            ...
            if (this.override)
              (0, _helpersSegmentJs.d).override(item.id, item.overrides);
            return scope;
          }
          get(id) {
        ...
        function registerDefaults(item, scope, parentScope) {
          ...
          if (item.descriptors)
            (0, _helpersSegmentJs.d).describe(scope, item.descriptors);
        }
          ...
          _each(method, args, typedRegistry) {
            [...args].forEach(arg => {
              ...
              if (
                ...
                (0, _helpersSegmentJs.F)(arg, item => {
                  const itemReg =
        ...
        class PluginService {
          ...
          _notify(descriptors, chart, hook, args) {
            ...
            for (const descriptor of descriptors) {
              ...
              if (
                (0, _helpersSegmentJs.Q)(method, params, plugin) === false &&
                args.cancelable
              )
                return false;
            }
          ...
          _createDescriptors(chart, all) {
            ...
            const options = (0, _helpersSegmentJs.v)(
        ...
        function mergeScaleConfig(config, options) {
          ...
          Object.keys(configScales).forEach(id => {
            ...
            if (!(0, _helpersSegmentJs.i)(scaleConf))
            ...
            const axis = determineAxis(
              ...
              (0, _helpersSegmentJs.d).scales[scaleConf.type]
            );
        ...
        class Config {
          ...
          getOptionScopes(mainScope, keyLists, resetCache) {
            ...
            keyLists.forEach(keys => {
              ...
              keys.forEach(key =>
                addIfFound(scopes, (0, _helpersSegmentJs.a3)[type] || {}, key)
              );
              keys.forEach(key =>
                addIfFound(scopes, (0, _helpersSegmentJs.d), key)
              );
              keys.forEach(key =>
                addIfFound(scopes, (0, _helpersSegmentJs.a6), key)
              );
            });
          ...
          resolveNamedOptions(scopes, names, context, prefixes = ['']) {
            ...
            if (needContext(resolver, names)) {
              result.$shared = false;
              context = (0, _helpersSegmentJs.a7)(context)
                ? context()
                : context;
              ...
              options = (0, _helpersSegmentJs.a8)(
                resolver,
                context,
                subResolver
              );
          ...
          createResolver(scopes, context, prefixes = [''], descriptorDefaults) {
            ...
            return (0, _helpersSegmentJs.i)(context)
              ? (0, _helpersSegmentJs.a8)(
                  resolver,
                  context,
                  undefined,
                  descriptorDefaults
        ...
        const hasFunction = value =>
          (0, _helpersSegmentJs.i)(value) &&
          Object.getOwnPropertyNames(value).reduce(
            (acc, key) => acc || (0, _helpersSegmentJs.a7)(value[key]),
            false
          );
        function needContext(proxy, names) {
          const { isScriptable, isIndexable } = (0, _helpersSegmentJs.aa)(
            proxy
          );
          for (const prop of names) {
            ...
            if (
              (scriptable &&
                ((0, _helpersSegmentJs.a7)(value) || hasFunction(value))) ||
              (indexable && (0, _helpersSegmentJs.b)(value))
            )
              return true;
          }
          return false;
        ...
        function getCanvas(item) {
          if ((0, _helpersSegmentJs.M)() && typeof item === 'string')
        ...
        class Chart {
          ...
          constructor(item, userConfig) {
            ...
            this.$context = undefined;
            this._doResize = (0, _helpersSegmentJs.ad)(
          ...
          _resize(width, height) {
            ...
            (0, _helpersSegmentJs.Q)(options.onResize, [this, newSize], this);
            if (this.attached) {
          ...
          buildOrUpdateScales() {
            ...
            (0, _helpersSegmentJs.F)(items, item => {
              ...
              const axis = determineAxis(id, scaleOptions);
              const scaleType = (0, _helpersSegmentJs.v)(
                scaleOptions.type,
                item.dtype
              );
              if (
          ...
          buildOrUpdateControllers() {
            ...
            for (i = 0, ilen = datasets.length; i < ilen; i++) {
              ...
              if (meta.controller) {
                ...
                const { datasetElementType, dataElementType } = (0,
          ...
          update(mode) {
            ...
            if (!animsDisabled)
              (0, _helpersSegmentJs.F)(newControllers, controller => {
                controller.reset();
              });
          ...
          _checkEventBindings() {
            ...
            if (
              !(0, _helpersSegmentJs.ag)(existingEvents, newEvents) ||
          ...
          getContext() {
            return (
              this.$context ||
              (this.$context = (0, _helpersSegmentJs.j)(null, {
                chart: this,
                type: 'chart',
              }))
            );
          ...
          bindUserEvents() {
            ...
            (0, _helpersSegmentJs.F)(this.options.events, type =>
              _add(type, listener)
            );
          }
        ...
        function invalidatePlugins() {
          return (0, _helpersSegmentJs.F)(Chart.instances, chart =>
        ...
        function clipArc(ctx, element, endAngle) {
          ...
          if (innerRadius > pixelMargin) {
            ...
            ctx.arc(
              ...
              y,
              pixelMargin,
              endAngle + (0, _helpersSegmentJs.H),
              startAngle - (0, _helpersSegmentJs.H)
            );
          ctx.closePath();
          ctx.clip();
        }
         ...
         */ function pathArc(ctx, element, offset, spacing, end, circular) {
          ...
          const beta =
            Math.max(
              0.001,
              alpha * outerRadius - offset / (0, _helpersSegmentJs.P)
            ) / outerRadius;
        ...
        function drawArc(ctx, element, offset, spacing, circular) {
          ...
          if (fullCircles) {
            ...
            if (!isNaN(circumference))
              endAngle =
                startAngle +
                (circumference % (0, _helpersSegmentJs.T) ||
                  (0, _helpersSegmentJs.T));
          }
          pathArc(ctx, element, offset, spacing, endAngle, circular);
          ctx.fill();
        ...
        class ArcElement extends Element {
          ...
          inRange(chartX, chartY, useFinalPosition) {
            ...
            const _circumference = (0, _helpersSegmentJs.v)(
              circumference,
              endAngle - startAngle
            );
            const betweenAngles =
              _circumference >= (0, _helpersSegmentJs.T) ||
              (0, _helpersSegmentJs.p)(angle, startAngle, endAngle);
            const withinRadius = (0, _helpersSegmentJs.aj)(
              distance,
              innerRadius + rAdjust,
              outerRadius + rAdjust
            );
          ...
          draw(ctx) {
            ...
            this.fullCircles =
              circumference > (0, _helpersSegmentJs.T)
                ? Math.floor(circumference / (0, _helpersSegmentJs.T))
                : 0;
            if (
              circumference === 0 ||
              this.innerRadius < 0 ||
            ...
            const fix =
              1 -
              Math.sin(Math.min((0, _helpersSegmentJs.P), circumference || 0));
        ...
        function setStyle(ctx, options, style = options) {
          ctx.lineCap = (0, _helpersSegmentJs.v)(
            style.borderCapStyle,
            options.borderCapStyle
          );
          ctx.setLineDash(
            (0, _helpersSegmentJs.v)(style.borderDash, options.borderDash)
          );
          ctx.lineDashOffset = (0, _helpersSegmentJs.v)(
            style.borderDashOffset,
            options.borderDashOffset
          );
          ctx.lineJoin = (0, _helpersSegmentJs.v)(
            style.borderJoinStyle,
            options.borderJoinStyle
          );
          ctx.lineWidth = (0, _helpersSegmentJs.v)(
            style.borderWidth,
            options.borderWidth
          );
          ctx.strokeStyle = (0, _helpersSegmentJs.v)(
            style.borderColor,
            options.borderColor
          );
        }
        ...
        class LineElement extends Element {
          ...
          get segments() {
            return (
              this._segments ||
              (this._segments = (0, _helpersSegmentJs.am)(
                this,
        ...
        class PointElement extends Element {
          ...
          draw(ctx, area) {
            ...
            if (
              this.skip ||
              options.radius < 0.1 ||
              !(0, _helpersSegmentJs.C)(this, area, this.size(options) / 2)
            )
              return;
            ctx.strokeStyle = options.borderColor;
        ...
        function parseBorderRadius(bar, maxW, maxH) {
          ...
          const skip = bar.borderSkipped;
          const enableBorder =
            enableBorderRadius || (0, _helpersSegmentJs.i)(value);
          return {
            topLeft: skipOrLimit(
        ...
        function inRange(bar, x, y, useFinalPosition) {
          ...
          return (
            bounds &&
            (skipX ||
              (0, _helpersSegmentJs.aj)(x, bounds.left, bounds.right)) &&
            (skipY || (0, _helpersSegmentJs.aj)(y, bounds.top, bounds.bottom))
          );
        }
        ...
        function minMaxDecimation(data, start, count, availableWidth) {
          ...
          for (i = start; i < start + count; ++i) {
            ...
            if (truncX === prevX) {
              ...
              const lastIndex = i - 1;
              if (
                !(0, _helpersSegmentJs.k)(minIndex) &&
                !(0, _helpersSegmentJs.k)(maxIndex)
              ) {
        ...
        function getStartAndCountOfVisiblePointsSimplified(meta, points) {
          ...
          if (minDefined)
            start = (0, _helpersSegmentJs.S)(
              (0, _helpersSegmentJs.B)(points, iScale.axis, min).lo,
              0,
              pointCount - 1
            );
          if (maxDefined)
            count =
              (0, _helpersSegmentJs.S)(
                (0, _helpersSegmentJs.B)(points, iScale.axis, max).hi + 1,
                start,
                pointCount
              ) - start;
        ...
        function _segments(line, target, property) {
          ...
          for (const segment of segments) {
            ...
            for (const tgt of targetSegments) {
              ...
              const fillSources = (0, _helpersSegmentJs.ax)(
                segment,
                points,
                subBounds
              );
        ...
        function _decodeFill(line, index, count) {
          ...
          if ((0, _helpersSegmentJs.i)(fill))
            return isNaN(fill.value) ? false : fill;
          let target = parseFloat(fill);
          if ((0, _helpersSegmentJs.g)(target) && Math.floor(target) === target)
        ...
        function _getTargetPixel(fill, scale) {
          ...
          else if ((0, _helpersSegmentJs.i)(fill))
        ...
        function parseFillOption(line) {
          ...
          let fill = (0, _helpersSegmentJs.v)(
        ...
        class Legend extends Element {
          ...
          adjustHitBoxes() {
            ...
            const rtlHelper = (0, _helpersSegmentJs.az)(
              rtl,
              this.left,
              this.width
            );
            if (this.isHorizontal()) {
              let row = 0;
              let left = (0, _helpersSegmentJs.a2)(
                align,
                this.left + padding,
              ...
              let col = 0;
              let top = (0, _helpersSegmentJs.a2)(
                align,
          ...
          _draw() {
            ...
            const drawLegendBox = function (x, y, legendItem) {
              if (
                ...
                return;
              ctx.save();
              const lineWidth = (0, _helpersSegmentJs.v)(
                legendItem.lineWidth,
                1
              );
              ctx.fillStyle = (0, _helpersSegmentJs.v)(
              ...
              ctx.setLineDash(
                (0, _helpersSegmentJs.v)(legendItem.lineDash, [])
              );
              if (labelOpts.usePointStyle) {
                const drawOptions = {
                ...
                const borderRadius = (0, _helpersSegmentJs.aw)(
            ...
            this.legendItems.forEach((legendItem, i) => {
              ...
              if (isHorizontal) {
                if (i > 0 && x + width + padding > this.right) {
                  ...
                  cursor.line++;
                  x = cursor.x = (0, _helpersSegmentJs.a2)(
                    align,
                    this.left + padding,
                ...
                cursor.line++;
                y = cursor.y = (0, _helpersSegmentJs.a2)(
                  align,
                  this.top + titleHeight + padding,
              ...
              if (isHorizontal) cursor.x += width + padding;
                ...
                cursor.y += calculateLegendItemHeight(
                  legendItem,
                  fontLineHeight
                );
          ...
          drawTitle() {
            ...
            const x = (0, _helpersSegmentJs.a2)(
              position,
              left,
              left + maxWidth
            );
            ctx.textAlign = rtlHelper.textAlign(
              (0, _helpersSegmentJs.a1)(position)
            );
            ctx.textBaseline = 'middle';
          ...
          _getLegendItemAt(x, y) {
            let i, hitBox, lh;
            if (
              (0, _helpersSegmentJs.aj)(x, this.left, this.right) &&
              (0, _helpersSegmentJs.aj)(y, this.top, this.bottom)
            ) {
              lh = this.legendHitBoxes;
              for (i = 0; i < lh.length; ++i) {
                hitBox = lh[i];
                if (
                  (0, _helpersSegmentJs.aj)(
                    x,
                    hitBox.left,
        ...
        function calculateLegendItemHeight(legendItem, fontLineHeight) {
          const labelHeight = legendItem.text
            ? legendItem.text.length + 0.5
            : 0;
            ...
            labels: {
              ...
              generateLabels(chart) {
                ...
                return chart._getSortedDatasetMetas().map(meta => {
                  ...
                  const borderWidth = (0, _helpersSegmentJs.E)(
                    style.borderWidth
                  );
                  return {
        ...
        class Title extends Element {
          ...
          update(maxWidth, maxHeight) {
            ...
            const lineCount = (0, _helpersSegmentJs.b)(opts.text)
              ? opts.text.length
              : 1;
            this._padding = (0, _helpersSegmentJs.E)(opts.padding);
            const textSize =
              lineCount * (0, _helpersSegmentJs.a0)(opts.font).lineHeight +
        ...
        function pushOrConcat(base, toPush) {
          if (toPush) {
            if ((0, _helpersSegmentJs.b)(toPush))
        ...
        function getBackgroundPoint(options, size, alignment, chart) {
          ...
          _helpersSegmentJs.aw)(cornerRadius);
        ...
        class Tooltip extends Element {
          ...
          _drawColorBox(ctx, pt, i, rtlHelper, options) {
            ...
            if (options.usePointStyle) {
              ...
              ctx.lineWidth = (0, _helpersSegmentJs.i)(labelColor.borderWidth)
          ...
          drawBackground(pt, ctx, tooltipSize, options) {
            ...
            const { topLeft, topRight, bottomLeft, bottomRight } = (0,
            _helpersSegmentJs.aw)(options.cornerRadius);
            ctx.fillStyle = options.backgroundColor;
            ctx.strokeStyle = options.borderColor;
            ctx.lineWidth = options.borderWidth;
            ctx.beginPath();
          ...
          handleEvent(e, replay, inChartArea = true) {
            ...
            const changed =
              replay ||
              !(0, _helpersSegmentJs.ah)(active, lastActive) ||
              positionChanged;
            if (changed) {
              this._active = active;
        ...
        const validIndex = (index, max) =>
          index === null
            ? null
            : (0, _helpersSegmentJs.S)(Math.round(index), 0, max);
            ...
            index =
              isFinite(index) && labels[index] === raw
                ...
                : findOrAddLabel(
                    labels,
                    raw,
                    (0, _helpersSegmentJs.v)(index, raw),
                    this._addedLabels
                  );
        ...
        function generateTicks$1(generationOptions, dataRange) {
          ...
          let spacing =
            (0, _helpersSegmentJs.aH)((rmax - rmin) / maxSpaces / unit) * unit;
          ...
          if (
            ...
            maxDefined &&
            step &&
            (0, _helpersSegmentJs.aI)((max - min) / step, spacing / 1000)
          ) {
          ...
          const decimalPlaces = Math.max(
            (0, _helpersSegmentJs.aK)(spacing),
            (0, _helpersSegmentJs.aK)(niceMin)
          );
          factor = Math.pow(
            10,
            (0, _helpersSegmentJs.k)(precision) ? decimalPlaces : precision
          );
        ...
        class LinearScaleBase extends Scale {
          ...
          buildTicks() {
            ...
            if (opts.bounds === 'ticks')
              (0, _helpersSegmentJs.aG)(ticks, this, 'value');
            if (opts.reverse) {
              ticks.reverse();
              this.start = this.max;
              this.end = this.min;
        ...
        class LinearScale extends LinearScaleBase {
          ...
          computeTickLimit() {
            ...
            const minRotation = (0, _helpersSegmentJs.t)(
        ...
        function generateTicks(generationOptions, { min, max }) {
          ...
          let value = (0, _helpersSegmentJs.O)(
          ...
          const lastTick = (0, _helpersSegmentJs.O)(
        ...
        class LogarithmicScale extends Scale {
          ...
          determineDataLimits() {
            ...
            if (
              ...
              !(0, _helpersSegmentJs.g)(this._userMin)
            )
              this.min =
          ...
          configure() {
            ...
            this._valueRange =
              (0, _helpersSegmentJs.aM)(this.max) -
              (0, _helpersSegmentJs.aM)(start);
          }
          getPixelForValue(value) {
            ...
            return this.getPixelForDecimal(
              value === this.min
                ? 0
                : ((0, _helpersSegmentJs.aM)(value) - this._startValue) /
                    this._valueRange
            );
          }
          getValueForPixel(pixel) {
          ...
          if (tickOpts.display && opts.display) {
            ...
            return (
              (0, _helpersSegmentJs.v)(
                ...
                (0, _helpersSegmentJs.d).font.size
              ) + padding.height
            );
          }
          return 0;
        ...
        function measureLabelSize(ctx, font, label) {
          label = (0, _helpersSegmentJs.b)(label) ? label : [label];
          return {
        ...
        function fitWithPointLabels(scale) {
          ...
          const additionalAngle = pointLabelOpts.centerPointLabels
            ? (0, _helpersSegmentJs.P) / valueCount
            : 0;
          for (let i = 0; i < valueCount; i++) {
            ...
            const angleRadians = (0, _helpersSegmentJs.ay)(
        ...
        function createPointLabelItem(scale, index, itemOpts) {
          ...
          const angle = Math.round(
            (0, _helpersSegmentJs.U)(
              (0, _helpersSegmentJs.ay)(
                pointLabelPosition.angle + (0, _helpersSegmentJs.H)
              )
            )
          );
        ...
        class RadialLinearScale extends LinearScaleBase {
          ...
          setDimensions() {
            const padding = (this._padding = (0, _helpersSegmentJs.E)(
          ...
          generateTickLabels(ticks) {
            ...
            this._pointLabels = this.getLabels()
              .map((value, index) => {
                const label = (0, _helpersSegmentJs.Q)(
          ...
          getIndexAngle(index) {
            const angleMultiplier =
              (0, _helpersSegmentJs.T) / (this._pointLabels.length || 1);
            const startAngle = this.options.startAngle || 0;
            return (0, _helpersSegmentJs.ay)(
              index * angleMultiplier + (0, _helpersSegmentJs.t)(startAngle)
            );
          }
        ...
        function parse(scale, input) {
          ...
          if (!(0, _helpersSegmentJs.g)(value))
            value =
          ...
          if (round)
            value =
              round === 'week' &&
              ((0, _helpersSegmentJs.x)(isoWeekday) || isoWeekday === true)
        ...
        class TimeScale extends Scale {
          ...
          determineDataLimits() {
            ...
            min =
              (0, _helpersSegmentJs.g)(min) && !isNaN(min)
                ? min
                : +adapter.startOf(Date.now(), unit);
            max =
              (0, _helpersSegmentJs.g)(max) && !isNaN(max)
                ? max
          ...
          _generate() {
            ...
            const stepSize = (0, _helpersSegmentJs.v)(
              options.ticks.stepSize,
              1
            );
            const weekday = minor === 'week' ? timeOpts.isoWeekday : false;
            const hasWeekday =
              (0, _helpersSegmentJs.x)(weekday) || weekday === true;
            const ticks = {};
            let first = min;
            let time, count;
          ...
          _getLabelSize(label) {
            ...
            const angle = (0, _helpersSegmentJs.t)(
              this.isHorizontal()
        ...
        function interpolate(table, val, reverse) {
          ...
          if (reverse) {
            if (val >= table[lo].pos && val <= table[hi].pos)
              ({ lo, hi } = (0, _helpersSegmentJs.B)(table, 'pos', val));
            ({ pos: prevSource, time: prevTarget } = table[lo]);
            ({ pos: nextSource, time: nextTarget } = table[hi]);
          } else {
            if (val >= table[lo].time && val <= table[hi].time)
              ({ lo, hi } = (0, _helpersSegmentJs.B)(table, 'time', val));
      ...
      {
        './chunks/helpers.segment.js': '7oQuk',
        '@kurkle/color': '2aojw',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'gkKU3',
      },
    ],
            ...
            if (minDefined)
              start = _limitValue(
                Math.min(
                  ...
                  animationsDisabled
                    ? pointCount
                    : _lookupByKey(points, axis, iScale.getPixelForValue(min))
                        .lo
                ),
                0,
                pointCount - 1
...
//# sourceMappingURL=index.51339dd5.js.map
